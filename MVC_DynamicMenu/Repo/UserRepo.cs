...
namespace MVC_DynamicMenu.Repo
{
	public class UserRepo
	{
		...
		public void InitRoleMenus()
		{
			...
			rm[22].Url = "/BudgetAggrement/AddNewBudgetAgreement";
			...
			rm[25].Url = "/ServiceSchedules/ShowAllSrviceInvoice";

			rm[26].Menu = "Patient";
			rm[26].Url = "/Patient/ShowPatients";

			rm[27].Menu = "Payment Requests";
			rm[27].Url = "/PaymentRequestControl/ShowAllPaymentRequest";
			...
			rm[32].Menu = "View All";
			rm[32].Url = "/Patient_Contact/ShowAllMainParticipant";

			rm[33].Menu = "All Patient In Melbourne";
			rm[33].Url = "/Patient_Contact/ViewParticipantByCity";

			rm[34].Menu = "Case Note";
			rm[34].Url = "/CaseNote/getAllCaseNote";

			rm[35].Menu = "On Call Dashboard";
			rm[35].Url = "/CallNote/ShowAllCallNote";

			rm[36].Menu = "Work";
			rm[36].Url = "#";

			rm[37].Menu = "Uavailability";
			rm[37].Url = "/Unavailability/GetAllUnavailability";

			rm[38].Menu = "Leave";
			rm[38].Url = "/Leave/GetAllLeave";

			rm[39].Menu = "Roster";
			rm[39].Url = "/roster/roster";

			rm[40].Menu = "Calendar";
			rm[40].Url = "/roster/calendar";
