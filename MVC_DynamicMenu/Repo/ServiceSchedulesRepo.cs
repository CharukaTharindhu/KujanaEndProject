...
namespace MVC_DynamicMenu.Repo
{
    public class ServiceSchedulesRepo
    {
        ...
        public void AddNewSS(ServiceSchedules model)
        {
            _c.ServiceSchedules.Add(model);
            _c.SaveChanges();
        }
        ...
        public void InsertDataIntoInvoice(InvoiceTb model)
        {
            ...
            _c.InvoiceTb.Add(newModel);
            _c.SaveChanges();
        }
        public void DeleteIN(int id)
        {
            var app = _c.ApprovedTb.FirstOrDefault(x => x.Reference == id);
            if (app != null)
            {
                _c.ApprovedTb.Remove(app);
                _c.SaveChanges();
            }
        }
        ...
        public List<MainBudgetAgreement> GetAllBudget()
        {
