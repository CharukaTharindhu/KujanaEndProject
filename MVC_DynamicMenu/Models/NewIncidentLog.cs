...
namespace MVC_DynamicMenu.Models
{
    public class NewIncidentLog
    {
        ...
        //public String L_Client_Complaint { get; set; }
        public String L_Disruption_to_Routine { get; set; }
       // public String L_Incident_Involving_Family { get; set; }
        public String L_Inappropriate_or_Anti_Social_Client_Interaction { get; set; }
        public String L_Injury_Minor_Client_Injury_First_Aid_Only { get; set; }
        //public String L_Non_Compliance_Task_Refusal { get; set; }
        //public String L_Attempted_Minor_Property_Damage { get; set; }
        ...
        public String L_Client_Complaint_or_issue { get; set; }
        public String Client_Complaint_or_issue { get; set; }
        public String IncidentInvolvingFamily { get; set; }
        public String L_IncidentInvolvingFamily { get; set; }
        //public String Non_Compliance_Refusal { get; set; }
        public String L_Non_Compliance_Refusal { get; set; }
        ...
        public String P_PhysicalIntervention { get; set; }
        ...
        public String L_Has_the_client_or_guardian_been_made_aware_of_their_right_to_involve_the_police_and_potentially_press_changes { get; set; }
