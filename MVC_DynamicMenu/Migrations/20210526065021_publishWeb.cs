...
{
    public partial class publishWeb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientID = table.Column<int>(nullable: false),
                    Client_Name = table.Column<string>(nullable: true),
                    Pending_Plans = table.Column<int>(nullable: false),
                    Approved_Plane = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodAndFluid", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    L_Disruption_to_Routine = table.Column<string>(nullable: true),
                    L_Inappropriate_or_Anti_Social_Client_Interaction = table.Column<string>(nullable: true),
                    L_Injury_Minor_Client_Injury_First_Aid_Only = table.Column<string>(nullable: true),
                    ...
                    L_Client_Complaint_or_issue = table.Column<string>(nullable: true),
                    Client_Complaint_or_issue = table.Column<string>(nullable: true),
                    IncidentInvolvingFamily = table.Column<string>(nullable: true),
                    L_IncidentInvolvingFamily = table.Column<string>(nullable: true),
                    L_Non_Compliance_Refusal = table.Column<string>(nullable: true),
                    ...
                    P_PhysicalIntervention = table.Column<string>(nullable: true),
                    ...
                    L_Has_the_client_or_guardian_been_made_aware_of_their_right_to_involve_the_police_and_potentially_press_changes = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Participant_City = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    External_Reference = table.Column<string>(nullable: true),
                    Created_Date = table.Column<string>(nullable: true),
                    Status = table.Column<string>(nullable: true),
                    Line_Item_Qty = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentRequest", x => x.PaymentID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Roster", x => x.TaskID);
                });
