...
namespace MVC_DynamicMenu.Data
{
    public class DynamicMenuDBContext:DbContext
    {
        ...
        public DbSet<AllocateBudgetAgreement> NewBudgetAgreement { get; set; }
        public DbSet<MainBudgetAgreement> BudgetAgreement { get; set; }
        ...
        public DbSet<NewCaseNote> NewCaseNote { get; set; }
        public DbSet<NewCallNote> NewCallNote { get; set; }

        public DbSet<AddDocument_Skill> AddDocument_Skill { get; set; }
        public DbSet<AddNewUnavailability> AddNewUnavailability { get; set; }
        public DbSet<AddNewLeave> AddNewLeave { get; set; }
        public DbSet<Files> File { get; set; }

        public DbSet<MainBudgetAgreement> MainBudgetAgreement { get; set; }
        public DbSet<AllocateBudgetAgreement> AllocateBudgetAgreement { get; set; }

        public DbSet<AdditionalActivityClass> AdditionalActivityClass { get; set; }

        public DbSet<MySupport> MySupport { get; set; }
        public DbSet<MyProfile> MyProfile { get; set; }

        public DbSet<RosterViewModel> Roster { get; set; }
