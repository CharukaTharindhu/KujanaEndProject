...
namespace MVC_DynamicMenu
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<NewCallNoteRepo, NewCallNoteRepo>();
            services.AddScoped<UnavailabilityRepo, UnavailabilityRepo>();
            services.AddScoped<LeaveRepo, LeaveRepo>();
            services.AddScoped<AddDocument_SkillRepo, AddDocument_SkillRepo>();
            services.AddScoped<NewCaseNoteRepo, NewCaseNoteRepo>();
            services.AddScoped<BudgetAgreementRepo, BudgetAgreementRepo>();
            services.AddScoped<RosterRepo, RosterRepo>();
            services.AddScoped<PyamentReqRepo, PyamentReqRepo>();
