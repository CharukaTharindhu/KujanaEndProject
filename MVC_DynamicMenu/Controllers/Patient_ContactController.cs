...
namespace MVC_DynamicMenu.Controllers
{
    public class Patient_ContactController : Controller
    {
        ...
        public ViewResult AddNewParticipant(Patient model)
        {
            ...
            model.Participant_City = model.Patient_Info[0].Office;
        ...
        */
        ...
        public ActionResult DeletePatient(int id)
        {
          ...
          [HttpGet]
        public ViewResult ViewParticipantByCity()
        {

           List<Patient> model= _c.GetpatientInfoByCity();
            return View(model);
        ...
        [HttpGet]
        public ViewResult ViewParticipantInfoByCity(int id)
        {
